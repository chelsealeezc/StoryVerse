  ...
  starLobby: {
    ...
    steps: [
      ...
      },
      {
        ...
        en: {
          title: "My stories",
          body: "Only the stars you wrote. Empty for now — we're about to light up the first one.",
        },
      },
      {
    ...
    steps: [
      {
        ...
        zh: {
          title: "来吧，我们写一个故事 ✎",
          body: "不用一开始就顾虑格式，也没有人会打分。\n\n想到哪写到哪 —— 提交前整理到 100–1500 字就好，这里本来就不是作文课。",
        },
        en: {
          title: "Alright — let's write one ✎",
          body: "Do not worry about format while you begin. Nobody is grading this.\n\nWrite freely, then shape it to 100–1500 characters before submitting. This was never an essay class.",
        },
      },
    ],
  },
    ...
    steps: [
      ...
      },
      {
        ...
        en: {
          ...
          body: "Publishing is anonymous. Once you confirm, your story becomes a real star in the sky.",
        },
      },
    ],
  },
