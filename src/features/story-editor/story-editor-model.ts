import clayStylePreview from "../../assets/image-styles/clay-3d.png";
import indieZineStylePreview from "../../assets/image-styles/indie-zine.png";
...
export const imageStyleOptions: Array<{
  ...
  // 图片仅用于帮助用户预览生成风格。
  {
    ...
    label: "3D粘土风",
    labelEn: "3D clay",
    description: "阿德曼式定格黏土，手工捏塑感与荒诞喜剧气质",
    descriptionEn: "Aardman-style stop-motion clay: fingerprints, matte surfaces, gentle absurdity",
