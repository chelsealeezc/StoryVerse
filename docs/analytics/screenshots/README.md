...
截图只记录页面设计和事件热点，不在真实用户运行时截图。每张图的编号标注说明如下：

| 编号   | 页面           | 热点                                            |
| ------ | -------------- | ----------------------------------------------- |
| ANA-01 | 首页与登录     | ①首页曝光 ②预览 ③注册/登录 ④语言/主题 ⑤找回密码 |
| ANA-02 | Icebreaker     | ①卡片曝光 ②选择 ③自定义入口 ④继续               |
| ANA-03 | StoryWrite     | ①标题 ②正文/粘贴 ③语音 ④专注 ⑤元数据 ⑥AI整理    |
| ANA-04 | StoryAnalyzing | ①分析开始/结果 ②失败重试 ③人工审核路由          |
| ANA-05 | StoryPage      | ①正文编辑 ②标签修改 ③图片风格/生成/下载 ④发布   |
| ANA-06 | 共鸣选择       | ①三个维度 ②相近/相异 ③确认                      |
| ANA-07 | 推荐页         | ①卡片曝光/点击 ②换一批 ③进入星图                |
| ANA-08 | StarLobby      | ①星点曝光/点击 ②搜索 ③底部导航 ④手势汇总        |
| ANA-09 | 故事面板       | ①有效阅读 ②喜欢/不喜欢 ③关闭                    |
